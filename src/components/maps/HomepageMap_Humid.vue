  ...
  data() {
    ...
    methods: {
        OverviewData() {
          ...
          .then(data=> {
            this.ShellKnob = data.STATION[0].OBSERVATIONS.relative_humidity_value_1.value
          })
          ...
          .then(data=> {
            this.Noel = data.STATION[0].OBSERVATIONS.relative_humidity_value_1.value
          })
          ...
          .then(data=> {
            this.Neosho = data.STATION[0].OBSERVATIONS.relative_humidity_value_1.value
          })
          ...
          .then(data=> {
            this.Wheaton = data.STATION[0].OBSERVATIONS.relative_humidity_value_1.value
          })
          ...
          .then(data=> {
            this.Republic = data.STATION[0].OBSERVATIONS.relative_humidity_value_1.value
          })
          ...
          .then(data=> {
            this.Cassville = data.STATION[0].OBSERVATIONS.relative_humidity_value_1.value
          })
          //Pea Ridge
          ...
          .then(data=> {
            this.PeaRidge = data.STATION[0].OBSERVATIONS.relative_humidity_value_1.value
          })
    }
    },
    mounted() {
